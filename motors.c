...
{
    printf("↑\nforward\n");
    foward(&motor1, 60, "config2");
    foward(&motor2, 60, "config1");
    foward(&motor3, 60, "config1");
    foward(&motor4, 60, "config2");
    delay(80);
    foward(&motor1, i +10, "config2");
...
int right(int i)
{
    foward(&motor1, 70, "config1");
    reverse(&motor2, 70, "config2");
    foward(&motor3, 70, "config1");
    reverse(&motor4, 70, "config2");
    delay(80);
    printf("→\nright\n");
